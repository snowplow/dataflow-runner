...
# Constants
bintray_package=dataflow-runner
...
dist_path=dist
build_dir=/opt/gopath/src/github.com/snowplow/dataflow-runner
...
# Build artifacts
build_artifact "${version}" "windows" "amd64" "dataflow-runner.exe"
build_artifact "${version}" "linux" "amd64" "dataflow-runner"
build_artifact "${version}" "darwin" "amd64" "dataflow-runner"
